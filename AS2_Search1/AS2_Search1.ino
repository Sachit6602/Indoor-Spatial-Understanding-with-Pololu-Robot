...
float x1,y1,cc;
int edge;
float first_e, second_e, third_e, fourth_e, fifth_e;
 ...
 // }
  ...
  if(DN[5]>750 && DN[6]>950 && count<=1){
    ...
    if(edge == 2){
      ...
      Serial.print("Side1:");
     Serial.println(((first_e)+(third_e))/2);
     Serial.print("Side2:");
     Serial.println(((second_e)+(fourth_e))/2);
     //Serial.print("Third Edge:");
     //Serial.println(third_e/5);
     //Serial.print("Fourth Edge:");
     //Serial.println(fourth_e/5);
